...
MASTER_LIST = [
  Song(
    ...
    Mode(
      ...
      "https://github.com/VictorTPhan/MasterSongList/raw/master/miniature_concerto/primo_pdf.mp3",
      [
    ...
    Mode(
      ...
      "https://github.com/VictorTPhan/MasterSongList/raw/master/miniature_concerto/secondo_pdf.mp3",
      [
        24.11, 58.44, 63.54, 91.15, 113.06, 140.96, 163.59, 190.49, 219.76,
        250.07
      ], [1, 1, 1, 1, 1, 1, 1, 1]),
    Mode(
      ...
      "https://github.com/VictorTPhan/MasterSongList/raw/master/miniature_concerto/both_pdf.mp3",
      [
        24.11, 58.44, 63.54, 91.15, 113.06, 140.96, 163.59, 190.49, 219.76,
        250.07
      ], [1, 1, 1, 1, 1, 1, 1, 1]),
  ...
  Song(
    ...
    Mode(
      ...
      "https://github.com/VictorTPhan/MasterSongList/raw/master/menuet/secondo_pdf.mp3",
      [46.97, 102.36, 135.04, 152.83, 165.71, 184.98, 208.62],
      [1, 1, 1, -1, 1, -3, 5]),
    Mode(
      "https://github.com/VictorTPhan/MasterSongList/raw/master/menuet/both_audio.mp3",
      "https://github.com/VictorTPhan/MasterSongList/raw/master/menuet/both_pdf.mp3",
      [46.97, 102.36, 135.04, 152.83, 165.71, 184.98, 208.62],
      [1, 1, 1, -1, 1, -3, 5])),
  Song(
    ...
    Mode(
      ...
      "https://github.com/VictorTPhan/MasterSongList/raw/master/concert/primo_pdf.mp3",
      [46.97, 102.36, 135.04, 152.83, 165.71, 184.98, 208.62],
      [1, 1, 1, -1, 1, -3, 5]),
    Mode(
      "https://github.com/VictorTPhan/MasterSongList/raw/master/concert/secondo_audio.mp3",
      "https://github.com/VictorTPhan/MasterSongList/raw/master/concert/secondo_pdf.mp3",
      [46.97, 102.36, 135.04, 152.83, 165.71, 184.98, 208.62],
      [1, 1, 1, -1, 1, -3, 5]),
    Mode(
      "https://github.com/VictorTPhan/MasterSongList/raw/master/concert/both_audio.mp3",
      "https://github.com/VictorTPhan/MasterSongList/raw/master/concert/both_pdf.mp3",
      [46.97, 102.36, 135.04, 152.83, 165.71, 184.98, 208.62],
      [1, 1, 1, -1, 1, -3, 5])),
  Song(
    "Concerto", "Billy Joel",
    Mode(
      ...
      "https://github.com/VictorTPhan/MasterSongList/raw/master/concerto/primo_pdf.mp3",
    ...
    Mode(
      ...
      "https://github.com/VictorTPhan/MasterSongList/raw/master/concerto/secondo_pdf.mp3",
      [46.97, 102.36, 135.04, 152.83, 165.61, 184.98, 208.62],
      [1, 1, 1, -1, 1, -3, 5]),
    Mode(
      "https://github.com/VictorTPhan/MasterSongList/raw/master/concerto/both_audio.mp3",
      "https://github.com/VictorTPhan/MasterSongList/raw/master/concerto/both_pdf.mp3",
      [46.97, 102.36, 135.04, 152.83, 165.61, 184.98, 208.62],
      [1, 1, 1, -1, 1, -3, 5])),
  Song(
    ...
    Mode(
      ...
      "https://github.com/VictorTPhan/MasterSongList/raw/master/easy_piano_duet/primo_pdf.mp3",
      [46.97, 102.36, 135.04, 152.83, 165.61, 184.98, 208.62],
      [1, 1, 1, -1, 1, -3, 5]),
    Mode(
      "https://github.com/VictorTPhan/MasterSongList/raw/master/easy_piano_duet/secondo_audio.mp3",
      "https://github.com/VictorTPhan/MasterSongList/raw/master/easy_piano_duet/secondo_pdf.mp3",
      [46.97, 102.36, 135.04, 152.83, 165.61, 184.98, 208.62],
      [1, 1, 1, -1, 1, -3, 5]),
    Mode(
      "https://github.com/VictorTPhan/MasterSongList/raw/master/easy_piano_duet/both_audio.mp3",
      "https://github.com/VictorTPhan/MasterSongList/raw/master/easy_piano_duet/both_pdf.mp3",
      [46.97, 102.36, 135.04, 152.83, 165.61, 184.98, 208.62],
      [1, 1, 1, -1, 1, -3, 5]))
]
